  ...
  return (
    <>
      <Head>
        ...
        <meta property="twitter:url" content="https://crackjobs.com/terms" />
        <meta property="twitter:title" content="Terms & Conditions | CrackJobs" />
        <meta property="twitter:description" content="Read the user agreement for CrackJobs." />
